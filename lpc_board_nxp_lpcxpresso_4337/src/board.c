...
static const io_port_t gpioLEDBits[] = {{LEDR_GPIO_PORT_NUM, LEDR_GPIO_BIT_NUM},
										{LEDG_GPIO_PORT_NUM, LEDG_GPIO_BIT_NUM},
										{LEDB_GPIO_PORT_NUM, LEDB_GPIO_BIT_NUM},
										{LED1_GPIO_PORT_NUM, LED1_GPIO_BIT_NUM},
										{LED2_GPIO_PORT_NUM, LED2_GPIO_BIT_NUM},
										{LED3_GPIO_PORT_NUM, LED3_GPIO_BIT_NUM}};

static const io_port_t gpioButtonBits[] = {{BUTTONS_TEC1_GPIO_PORT_NUM, BUTTONS_TEC1_GPIO_BIT_NUM},
										   {BUTTONS_TEC2_GPIO_PORT_NUM, BUTTONS_TEC2_GPIO_BIT_NUM},
										   {BUTTONS_TEC3_GPIO_PORT_NUM, BUTTONS_TEC3_GPIO_BIT_NUM},
										   {BUTTONS_TEC4_GPIO_PORT_NUM, BUTTONS_TEC4_GPIO_BIT_NUM}};
#endif
